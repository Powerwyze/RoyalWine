...
export async function mountAvatar(face,canvas){
  ...
  scene.add(new THREE.HemisphereLight(0xfff2df,0x24324d,1.55));
  for(const [color,intensity,position] of [[0xffe4cb,2.35,[-3,3,4]],[0x9ac8df,1.0,[3,1,3]],[0xefaa9b,2.0,[0,2,-2]]]){
